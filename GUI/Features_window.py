...
class FeatureSelectionWindow(QtWidgets.QDialog):
    def __init__(self, features, parent=None):
        ...
        self.scroll_layout = QtWidgets.QGridLayout(self.scroll_widget)  # Using QGridLayout to arrange in columns
        ...
        self.ok_button.clicked.connect(self.accept)  # Close the window when clicked
